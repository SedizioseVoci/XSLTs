<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- JRN 2022-08-27 Remediation XSLT for ETDs in Niner Commons; matches on ProQuest subject terms in ETDs and assigns one or more matching FAST terms from the OpenRefine reconciliation -->
    <!-- JRN 2021-08-27 Doesn't make adjustments to recordInfo element; those adjustments will be made in second XSLT that removes duplicates and problematic accessCondition elements. Removed final element that deletes the ProQuest subject vocabulary terms and student keywords -->
